  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="w-full max-w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-8 sm:gap-10 lg:gap-10 xl:gap-14">
          ...
          <motion.div
            ...
            className="w-full max-w-full col-span-1 lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 sm:space-y-7 min-w-0"
          >
            <h2 className="font-primary text-2xl sm:text-4xl md:text-5xl lg:text-[42px] xl:text-[50px] 2xl:text-[54px] font-normal leading-[1.2] text-white tracking-tight capitalize max-w-lg break-words">
            ...
            <p className="font-secondary text-xs sm:text-base md:text-lg text-white/80 font-normal leading-relaxed max-w-md lg:max-w-lg break-words">
